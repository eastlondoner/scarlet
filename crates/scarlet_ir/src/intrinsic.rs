...
intrinsics! {
    ...
    InternalLiveHandles = "internal__live_handles",
    InternalBytesStaged = "internal__bytes_staged",
    ...
    MetalDevice = "metal__device",
    MetalName = "metal__name",
    MetalBuffer = "metal__buffer",
    MetalRead = "metal__read",
    MetalByteSize = "metal__byte_size",
