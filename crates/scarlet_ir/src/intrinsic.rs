...
intrinsics! {
    ...
    BinaryConcat = "binary__concat",
    BinaryRepeat = "binary__repeat",
    BinaryFromBytes = "binary__from_bytes",
    BinaryFromFloats32 = "binary__from_floats32",
    BinaryToFloats32 = "binary__to_floats32",
